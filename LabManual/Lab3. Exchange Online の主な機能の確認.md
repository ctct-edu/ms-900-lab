...
23. **[メンバーの追加]** ページで、 **[Diego Siciliani]** と **[Lynne Robbins]** の左にあるチェックボックスをオンにし、 **[追加(Add)] (2)** ボタンをクリックします。
...
6. ブラウザーを(シークレット/InPrivateウィンドウでない場合は、サインアウトも実施して)閉じます。再度ブラウザーを起動し、Microsoft 365 ポータル (https://portal.office.com) に以下の資格情報でサインインします。
