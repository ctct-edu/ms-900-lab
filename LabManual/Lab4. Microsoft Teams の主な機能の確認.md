...
1. InPrivate ウィンドウ(Microsoft Edge) もしくは、シークレットウィンドウ (Google Chrome) で、Teams 管理センター (https://admin.teams.microsoft.com) にアクセスし、以下の資格情報でサインインします。
...
4. Teams 管理センターの左ナビゲーションペインから、 **[チーム]** を選択し、 **[チームを管理する(Manage Teams)]** をクリックします。


　![lab4-1](./media/lab4-1.png)

5.  **[チームを管理する]** ページで、 **[ ＋ 追加] (+Add)** をクリックします。
...
8.  **[マーケティング]** チームページの **[メンバー]** タブが表示されている状態で、 **[ ＋ メンバーの追加(Add members)] ** をクリックします。
...
11.  Microsoft 365 管理センターを表示しているブラウザーのタブに切り替えます。(ない場合はMicrosoft 365 管理センターにアクセスし、Holly Dicksonでサインインしてください)
...
19.  **[進捗報告]** チャネルが追加されたことが確認出来たら、 **[投稿]** をクリックして任意のメッセージを投稿します。
