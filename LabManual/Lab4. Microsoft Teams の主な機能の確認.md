...
12.  任意のメッセージを投稿できるか確認します。
13.  **[Marketing]** チャネル右の **[・・・]** をクリックし、 **[チャネルを追加]** をクリックします。
...
20. Holly が追加したMarketingProjectと、進捗報告チャネルが追加されていることが確認できます。
