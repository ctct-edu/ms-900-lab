...
10. アプリの一覧から **[Teams]** を選択し、Teamsを起動します。

    <img src="./media/lab4-17.png" alt="lab4-17" style="zoom:33%;" />

11. サインインを求められた場合は、**[サインイン]** をクリックした後、「アカウントを選択する」ページで Holly Dickson を選択してサインインします。

    ※ 初回サインインのため、環境準備を1分程度待った後、「Teamsを知ってもらう」画面を「開始」で閉じ、「最後に...](QRコードが表示されます)の画面は右上の **[ × ]** をクリックして閉じます。

12. **[チャネル] - [新しいアイテム(下向きのアイコン)] - [新しいチーム]** とクリックします
...
15.  **[進捗報告]** チャネルが追加されたことが確認出来たら、 **[投稿の開始(Post in channel)]** をクリックして任意のメッセージを投稿します。
