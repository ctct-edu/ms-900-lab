...
18. 左のタスクバーの **[アプリ]** から **[Teams]** を選択します。

20. 一般チャネルにHolly が追加したMarketingProjectタブがあり、進捗報告チャネルが追加されていることが確認できます。もし余力があれば、MarketingProjectタブでIsaiahLに割り当てられたタスク等をできる限りで構いませんので、確認してみてください。
