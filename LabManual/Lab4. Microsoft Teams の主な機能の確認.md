...
14. **[チームを作成する]** ページで、 **[最初から]** をクリックします。

15. **[チームの種類は何でしょうか?]** ページで、 **[プライベート]** をクリックします。

16. **[プライベート チームの簡単な説明]** ページでチーム名を、 **[マーケティング]** と入力し、 **[作成]** をクリックします。

17. **[マーケティングにメンバーを追加]** ページで **[Megan Bowen]** と入力して検索し、リストされた **[Megan Bowen]** をクリックし、 **[追加]** をクリックします。

    ![](./media/lab4-3-0.png)

18. 続いて **[Isaiah Langer]** と入力して検索し、リストされた **[Isaiah Langer]** をクリックし、 **[追加]** をクリックします。

19. **[Megan Bowen]** と **[Isaiah Langer]** が表示されたことを確認して、 **[閉じる]** をクリックします。
