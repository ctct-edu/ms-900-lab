...
### <a name="task-1-Recipient-management"></a>タスク 1: チームの作成
...
6.  **[新しいチームを追加]** ページが表示されたら、以下を入力して、 **[申し込み]** をクリックします。
...
　<img src="./media/lab4-3.png" alt="lab4-3" style="zoom:67%;" />

2. **[表示名]** の一覧から、 **[Joni Sherman]** のメールボックスを選択します。

3. **[Joni Sherman]** ページで、 **[委任]** タブを選択します。

   <img src="./media/lab3-3.png" alt="lab3-3" style="zoom:67%;" />

   

4. **[Joni Sherman]** の **[委任]** タブ内にある、 **[読み取りと管理 (フル アクセス)]** セクションの下に表示される  **[編集]** ボタンをクリックします。

   <img src="./media/lab3-4.png" alt="lab3-4" style="zoom:67%;" />

5. **[メールボックス委任の管理]** ページで、 **[ +メンバーの追加]** をクリックします。

6. **[読み取りアクセス許可の追加と管理アクセス許可]** ページで、 ユーザー アカウントの一覧から **[Holly Dickson]** の左にあるチェックボックスをオンにし、 **[保存]** ボタンをクリックしてから、 **[確認]** を選択します。

7. **「アクセス許可の委任を追加しますか?」** ページが表示されたら、 **[確認]** をクリックします。

8. 「これらのメールボックスにメールボックスのアクセス許可が追加されました」 ページが表示されたら、ページの右上にある [ × ] をクリックして閉じます。
