...
18. **[マーケティングにメンバーを追加]** ページで **[Megan Bowen]** と入力して検索し、リストされた **[Megan Bowen]** をクリックし、 **[追加]** をクリックします。

    ![](./media/lab4-3-0.png)

19. 続いて **[Isaiah Langer]** と入力して検索し、リストされた **[Isaiah Langer]** をクリックし、 **[追加]** をクリックします。
...
19.  **[進捗報告]** チャネルが追加されたことが確認出来たら、 **[投稿を開始する]** をクリックして任意のメッセージを投稿します。
