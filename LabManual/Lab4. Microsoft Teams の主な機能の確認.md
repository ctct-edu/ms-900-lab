...
6. **[パスワード]** ボックスに **「Pa55w.rd1234」** と入力して、 **[初回サインイン時にこのユーザーにパスワードの変更を要求する]** チェックボックスをオフにします。

7. **[パスワードのリセット]** をクリックします。

8. **「パスワードがリセットされました」** と表示されたことを確認し、 **[閉じる]** ボタンをクリックします。

9. **[Isaiah Langer]** のアカウントでも、13 ～ 17 の手順を繰り返し、パスワードをリセットします。
...
12. **[チームをまとめましょう]** ページが表示されたら、右上の **[ × ]** をクリックします。<img src="./media/lab4-7.png" alt="lab4-7" style="zoom:33%;" />

13. **[＋(チームに参加または作成する)]** をクリックします
...
15. **[チームを作成する]** ページで、 **[最初から]** をクリックします。

16. **[チームの種類は何でしょうか?]** ページで、 **[プライベート]** をクリックします。

17. **[プライベート チームの簡単な説明]** ページでチーム名を、 **[マーケティング]** と入力し、 **[作成]** をクリックします。

18. **[マーケティングにメンバーを追加]** ページで **[Megan Bowen]** を検索し、リストされた **[Megan Bowen]** をクリックし、 **[追加]** をクリックします。

19. 続いて **[Isaiah Langer]** を検索し、リストされた **[Isaiah Langer]** をクリックし、 **[追加]** をクリックします。

20.  **[Megan Bowen]** と **[Isaiah Langer]** が表示されたことを確認して、 **[閉じる]** をクリックします。
...
3.  **[Microsoft によるビルド]** の一覧から **[Planner および To Do タスク Tasks]** を選択します。
