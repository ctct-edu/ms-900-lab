...
12.  **[既定のテーマ]** ページで、 **[色]** タブをクリックし、 **[ナビゲーションバーの色]** の黒いボタンをクリックします。
    ...
    <img src="./media/lab1-16.png" alt="lab1-16" style="zoom:67%;" />

13. カラーパレットから任意の色を選択します。 

    **※注意※以下のようにパレット内に警告マークが表示された場合、その色は推奨されないため、使用可能な色 (濃色)を選択してください。**

    ![lab1-17](./media/lab1-17.png)

14. 色を選択したら、 **[保存]** ボタンをクリックします。

15. 「変更内容が保存されました。」というメッセージが表示されたことを確認して、 **[既定のテーマ]** ページを画面右上の [x] をクリックして閉じます。 

16.  **[F5] キー** を押して、ページを更新します。 

17. 画面上部のナビゲーションバーの色が変更されたことを確認します。
