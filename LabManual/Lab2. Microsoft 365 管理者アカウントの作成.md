...
4. **[アクティブなユーザー]** ページで、 **[Adele Vance]** のチェックボックスをオンにし、 **[ユーザーの削除]** をクリックします。

5. **[Adele Vance の削除]** ページで、 **[ユーザーの削除]** をクリックします。

6.  **[閉じる] をクリックします。**

7. **[アクティブなユーザー]** ページで、 **[ユーザーの追加]** をクリックします。
...
<img src="./media/lab2-3-m.png" alt="lab2-3-m" style="zoom: 50%;" />
