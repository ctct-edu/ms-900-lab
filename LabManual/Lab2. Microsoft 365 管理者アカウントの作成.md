...
| **パスワード**                                               | Pa55w.rd1234                                                 |
| **初回サインイン時にこのユーザーにパスワードの変更を要求する** | 既定(チェックボックスオン)                                       |
...
2. パスワードの更新を求められたら、以下に変更します。

| 項目           | 値                                                           |
| -------------- | ------------------------------------------------------------ |
| **現在のパスワード** | Pa55w.rd1234 |
| **新しいパスワード** | Pa55w.rd12345                                                 |

3.  **[サインインの状態を維持しますか]** ページが表示された場合は、 **[いいえ]** をクリックします 。
...
22. 3人のメンバーが追加されたことを確認し、 **[販売グループにメンバーを追加する]** ページで、  **[閉じる]** ボタンをクリックします。

![lab2-10](./media/lab2-10.png)

23. 再度 **[販売グループ]** を表示し、  **[メンバーシップ]** タブをクリックします。 メニューを **[メンバー]** に切り替えると、21の手順で追加したユーザーがメンバーとして追加されていることが確認できます。 
